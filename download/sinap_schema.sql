-- Sinap Schema — Copia y pega esto en Supabase SQL Editor
-- Si alguna tabla ya existe, simplemente omite el error y continua
...
-- ═══════════════════════════════════════════
-- INDEXES (usamos IF NOT EXISTS para seguridad)
-- ═══════════════════════════════════════════
