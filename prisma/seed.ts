...
async function main() {
  console.log('🌱 Seeding Sinap database...\n')

  // ─── 1. CLINIC ─────────────────────────────────────────
  console.log('1️⃣  Creating clinic...')
  ...
  // ─── 2. DOCTORS ────────────────────────────────────────
  console.log('2️⃣  Creating doctors...')
  ...
  console.log('   ✅ demo@sinap.health / demo1234\n')
  ...
  console.log(`   ✅ ${serviceDefs.length} services created\n`)

  // ─── 5. SERVICE-DOCTOR PIVOTS ──────────────────────────
  console.log('5️⃣  Creating service-doctor pivots...')
  for (const svc of serviceDefs) {
    ...
    for (const doctorId of ['demo-doctor-1', 'demo-doctor-2']) {
      await prisma.serviceDoctor.upsert({
        ...
        update: {},
        create: { serviceId, doctorId },
      })
    }
  }
  console.log(`   ✅ ${serviceDefs.length * 2} service-doctor links\n`)

  // ─── 6. PATIENTS ───────────────────────────────────────
  console.log('6️⃣  Creating patients...')
  const patientsData = [
    {
      id: 'demo-patient-1',
      firstName: 'Maria',
    ...
    },
    {
      ...
      totalSpent: 3800,
      ltv: 3800,
      lastVisitDate: daysAgo(75),
      firstContactDate: daysAgo(130),
      allergies: null,
  ...
  const appointmentsData = [
    {
      ...
      serviceId: 'svc-revision-dermatologica',
      date: today(),
      startTime: '10:00',
      endTime: '10:45',
      status: 'confirmed',
    ...
    },
    {
      ...
      status: 'completed',
      channel: 'whatsapp',
      notes: 'Dermatitis atopica - ajuste de tratamiento topico.',
    },
    {
      id: 'demo-apt-6',
      patientId: 'demo-patient-1',
      doctorId: 'demo-doctor-1',
      serviceId: 'svc-tratamiento-laser',
      date: daysAgo(2),
      startTime: '09:00',
      endTime: '09:45',
      status: 'completed',
    ...
    },
    {
      ...
      doctorId: 'demo-doctor-1',
      serviceId: 'svc-consulta-estetica',
      date: daysAgo(3),
      startTime: '12:00',
      endTime: '12:30',
      status: 'cancelled',
    ...
    },
    {
      ...
      status: 'completed',
      channel: 'whatsapp',
      notes: 'Consulta estetica facial. Interesada en peeling quimico.',
    },
  ]
  ...
  const invoicesData = [
    ...
    },
    {
      ...
      serie: 'A',
      folio: '002',
      fechaTimbrado: daysAgo(1),
    },
    {
      id: 'demo-inv-3',
      patientId: 'demo-patient-4',
      appointmentId: 'demo-apt-9',
      subtotal: 3500,
      iva: 560,
      total: 4060,
      formaPago: '04',
    ...
    },
    {
      ...
      serie: 'A',
      folio: '004',
      fechaTimbrado: daysAgo(8),
    },
    {
      id: 'demo-inv-9',
      patientId: 'demo-patient-2',
      appointmentId: 'demo-apt-12',
      subtotal: 2000,
      iva: 320,
      total: 2320,
      formaPago: '03',
  ...
  console.log('9️⃣  Creating conversations and messages...')
  ...
  for (const conv of conversationsData) {
    await prisma.conversation.upsert({
      ...
      create: {
        ...
        routedToHuman: conv.routedToHuman ?? false,
        isMock: true,
  ...
  console.log(`   ✅ ${conversationsData.length} conversations with ${conversationsData.reduce((sum, c) => sum + c.messages.length, 0)} messages\n`)
  ...
  // ─── 11. SOAP NOTES ────────────────────────────────────
  console.log('1️⃣1️⃣  Creating SOAP notes...')
  ...
  await prisma.soapNote.upsert({
    ...
    create: {
      ...
      doctorId: 'demo-doctor-1',
      subjective:
        'Paciente femenina de 36 anos que acude a sesion de tratamiento laser para melanoma in situ en antebrazo izquierdo. Refiere buena tolerancia a sesiones previas. No refiere dolor, ardor ni cambios en la lesion. Ha seguido indicaciones de proteccion solar.',
      objective:
        'Antebrazo izquierdo: lesion hiperpigmentada de 8mm, bordes bien definidos, sin cambios de tamano ni color respecto a sesion anterior. Piel perilesional sin alteraciones. No signos de inflamacion ni infeccion. Vitales: TA 118/76, FC 72, Temp 36.4C.',
      assessment:
        'Melanoma in situ en antebrazo izquierdo en tratamiento con laser. Evolucion favorable sin progresion. Se continua esquema de sesiones quincenales. Diagnostico CIE-10: D03.2.',
      plan:
        '1. Continuar tratamiento laser quincenal (3 sesiones restantes). 2. Proteccion solar SPF 50+ estricta. 3. Revision dermatologica en 4 semanas. 4. Biopsia de control en 3 meses si no hay mejoria. 5. Entregar informe a oncologo tratante.',
      aiGenerated: true,
      aiSuggested: true,
      doctorApproved: true,
      ...
      prescriptions: JSON.stringify([
        { medication: 'Protector solar SPF 50+', frequency: 'Cada 2 horas', duration: 'Indefinido' },
      ]),
    },
  })

  // Draft SOAP note (AI generated, not yet approved)
  await prisma.soapNote.upsert({
    ...
    create: {
      ...
      doctorId: 'demo-doctor-1',
      subjective:
        'Paciente masculino de 49 anos con acne cronico en cara. Refiere mejoria parcial con tratamiento de retinoides topicos. Presenta brote leve en zona mandibular desde hace 1 semana. Niega uso de nuevos productos cosmeticos. Ha cumplido con esquema de aplicacion nocturna.',
      objective:
        'Piel facial con comedones no inflamatorios en zona frontal y nasal. Papulas eritematosas en region mandibular bilateral (4-5 lesiones). No nodulos ni quistes. Piel seca en zonas de aplicacion de retinoides. Escala de severidad: leve-moderada.',
      assessment:
        'Acne vulgar cronico leve-moderado en brote mandibular. Buena respuesta parcial a retinoico topico. Posible ajuste de tratamiento. Diagnostico CIE-10: L70.0.',
      plan:
        '1. Ajustar retinoide topico a concentracion mayor (0.05% a 0.1%). 2. Agregar acido azelaico al manejo matutino. 3. Hidratacion facial con crema libre de aceite. 4. Control en 4 semanas. 5. Considerar terapia combinada si no mejoria.',
      aiGenerated: true,
      aiSuggested: true,
  ...
  console.log('   ✅ 2 SOAP notes (1 approved, 1 draft)\n')

  // ─── 12. EVENT BUS ──────────────────────────────────────
  console.log('1️⃣2️⃣  Creating event bus entries...')
  const eventsData = [
    {
      id: 'demo-event-1',
      ...
      payload: JSON.stringify({
        ...
        service: 'Revision dermatologica',
      }),
      status: 'processed',
      processedAt: daysAgo(2, 9, 22),
      createdAt: daysAgo(2, 9, 21),
    },
    {
      id: 'demo-event-2',
      ...
      status: 'processed',
      processedAt: daysAgo(2, 10, 0),
      createdAt: daysAgo(2, 9, 55),
    },
    {
      id: 'demo-event-3',
      eventType: 'soap_borrador_listo',
      sourceAgent: 'flow',
      targetAgent: 'desk',
      payload: JSON.stringify({
        soapNoteId: 'demo-soap-2',
        patientId: 'demo-patient-2',
        appointmentId: 'demo-apt-4',
      }),
      status: 'pending',
    ...
    },
    {
      ...
      status: 'processed',
      processedAt: daysAgo(1, 14, 50),
      createdAt: daysAgo(1, 14, 45),
    },
    {
      id: 'demo-event-5',
      eventType: 'paciente_nuevo',
      sourceAgent: 'desk',
      targetAgent: 'grow',
      payload: JSON.stringify({
        patientId: 'demo-patient-6',
        name: 'Fernando Diaz Vega',
        source: 'walk_in',
        firstVisit: daysAgo(3).toISOString(),
      }),
      status: 'processed',
      processedAt: daysAgo(3, 10, 30),
      createdAt: daysAgo(3, 10, 15),
    },
  ]

  for (const evt of eventsData) {
    await prisma.eventBus.upsert({
      where: { id: evt.id },
      update: {},
      create: {
        ...evt,
  ...
  console.log(`   ✅ ${eventsData.length} event bus entries\n`)
  ...
  console.log('   • 2 SOAP Notes')
  console.log(`   • ${eventsData.length} Event Bus entries`)
  console.log('   • 1 Demo user (demo@sinap.health / demo1234)')
  console.log('')
  console.log('🔐 Login: demo@sinap.health / demo1234')
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
}
